...
class CodeSysVariable {
    ...
    getVariableCreationString() {
        return `${this.name}=${this.getVarType()}`;
    }

    getVariableCreationString2() {
    ...
    getDisplayName() {
        return `${this.fitCharsEnglish(this.name)} AT%${CodeSysVariable.getATDeclaration(this.codeSysType)}${CodeSysVariable.wordAddressToString(this.wordAddress, this.codeSysType)}:${this.codeSysType};`;
    }
}
...
class BoolCodeSysVariable extends CodeSysVariable {
    ...
    getDisplayName() {
        return `${this.fitCharsEnglish(this.name)} AT%${CodeSysVariable.getATDeclaration(this.codeSysType)}${CodeSysVariable.wordAddressToString(this.wordAddress, this.codeSysType)}.${this.bitNumber}:${this.codeSysType};`;
    }
}
